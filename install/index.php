...
//程序安装文件
error_reporting(0);
$databaseFile = '../Config/Config.php';//数据库配额文件
...
");
            ...
            $sqls=file_get_contents('table.sql');
            $sqls=explode(';', $sqls);
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">2、后台地址：<a href="/admin/" target="_blank">/admin/</a> 密码:admin</li>
                ...
                <div class="panel-body">
                    ...
                    if(function_exists('MemcacheModel')){
                        $check[4]='<span class="badge">不支持</span>';
                    }else{
                        $check[4]='<span class="badge">支持</span>';
                    }
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">PHP版本>=5.4 <?php echo $check[3];?></li>
                         <li class="list-group-item">memcached <?php echo $check[4];?></li>
